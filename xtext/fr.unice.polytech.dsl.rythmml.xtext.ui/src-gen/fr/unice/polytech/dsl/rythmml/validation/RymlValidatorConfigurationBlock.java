 ...
 */
package fr.unice.polytech.dsl.rythmml.validation;
...
public class RymlValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(RymlConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Ryml");
		if (section == null) {
			return dialogSettings.addNewSection("Ryml");
		}
		return section;
	}
}
