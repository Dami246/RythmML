...
public class RymlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RymlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMusicAccess().getOwnedPatternsAssignment_3_0_0(), "rule__Music__OwnedPatternsAssignment_3_0_0");
			builder.put(grammarAccess.getMusicAccess().getOwnedPatternsAssignment_3_0_1(), "rule__Music__OwnedPatternsAssignment_3_0_1");
			builder.put(grammarAccess.getMusicAccess().getOwnedSectionsAssignment_3_1(), "rule__Music__OwnedSectionsAssignment_3_1");
			builder.put(grammarAccess.getMusicAccess().getOwnedSectionsAssignment_3_2(), "rule__Music__OwnedSectionsAssignment_3_2");
			...
			builder.put(grammarAccess.getBarAccess().getBeatsAssignment_3(), "rule__Bar__BeatsAssignment_3");
			builder.put(grammarAccess.getBarAccess().getBeatsAssignment_4_1(), "rule__Bar__BeatsAssignment_4_1");
