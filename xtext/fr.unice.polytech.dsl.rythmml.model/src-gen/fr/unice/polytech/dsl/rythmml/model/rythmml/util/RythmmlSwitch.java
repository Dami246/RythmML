...
public class RythmmlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RythmmlPackage.NOTE_ADDITION: {
			NoteAddition noteAddition = (NoteAddition) theEObject;
			T result = caseNoteAddition(noteAddition);
			if (result == null)
				result = caseOperation(noteAddition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RythmmlPackage.NOTE_DELETION: {
			NoteDeletion noteDeletion = (NoteDeletion) theEObject;
			T result = caseNoteDeletion(noteDeletion);
			if (result == null)
				result = caseOperation(noteDeletion);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RythmmlPackage.NOTE_REPLACEMENT: {
			NoteReplacement noteReplacement = (NoteReplacement) theEObject;
			T result = caseNoteReplacement(noteReplacement);
			if (result == null)
				result = caseOperation(noteReplacement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Note Addition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Note Addition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNoteAddition(NoteAddition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Note Deletion</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Note Deletion</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNoteDeletion(NoteDeletion object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Note Replacement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Note Replacement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNoteReplacement(NoteReplacement object) {
		return null;
	}
