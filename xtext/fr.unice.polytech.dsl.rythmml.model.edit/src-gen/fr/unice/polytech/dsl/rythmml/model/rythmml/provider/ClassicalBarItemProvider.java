...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.dsl.rythmml.model.rythmml.ClassicalBar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassicalBarItemProvider extends BarItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ClassicalBarItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ClassicalBar"));
	}
	...
	public String getText(Object object) {
		String label = ((ClassicalBar) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ClassicalBar_type")
				: getString("_UI_ClassicalBar_type") + " " + label;
	}
