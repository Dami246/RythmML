...
public class ModifiedBarItemProvider extends BarItemProvider {
	...
	protected void addOperationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModifiedBar_operations_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModifiedBar_operations_feature",
								"_UI_ModifiedBar_type"),
						RythmmlPackage.Literals.MODIFIED_BAR__OPERATIONS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RythmmlPackage.Literals.MODIFIED_BAR__OPERATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModifiedBar.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RythmmlPackage.Literals.MODIFIED_BAR__OPERATIONS,
				RythmmlFactory.eINSTANCE.createNoteAddition()));

		newChildDescriptors.add(createChildParameter(RythmmlPackage.Literals.MODIFIED_BAR__OPERATIONS,
				RythmmlFactory.eINSTANCE.createNoteDeletion()));

		newChildDescriptors.add(createChildParameter(RythmmlPackage.Literals.MODIFIED_BAR__OPERATIONS,
				RythmmlFactory.eINSTANCE.createNoteReplacement()));
	}
